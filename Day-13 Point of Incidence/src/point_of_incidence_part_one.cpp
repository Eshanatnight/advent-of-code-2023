...
auto is_mirror_col(const std::vector<std::string>& patterns, int mirror_column, int test_column) -> int64_t {
...
auto is_mirror_row(const std::vector<std::string>& patterns, int64_t mirror_row, int64_t test_row) -> bool {
